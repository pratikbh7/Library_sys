    ...
    <div id="admin-login">
        <form id="installation-form" method="POST"> 
            <div class="input-group" id="ad_name">
                ...
                <input required type="text" name="set_admin[username]" id="admin_name" autocomplete="off" placeholder="username" value=""> 
            </div>
            <div class="input-group" id="ad_pass">
                <label for="admin_password">Password:</label>
                <input required type="password" name="set_admin[password]" id="admin_password" autocomplete="off" placeholder="password" value=""> 
            </div>
